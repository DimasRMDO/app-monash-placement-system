...
--
-- Host: localhost:3306
-- Generation Time: Jun 01, 2021 at 01:52 AM
...
--
CREATE DATABASE IF NOT EXISTS `u20s2129_backend_setup` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `u20s2129_backend_setup`;
...
--
ALTER TABLE `agreement_progress`
  MODIFY `agreement_progress_id` int(6) NOT NULL AUTO_INCREMENT;
