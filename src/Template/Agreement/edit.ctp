                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <?php echo $this->Form->control('provider_id', ['label'=>'','id'=>'val-username', 'class'=>'form-control', 'options' => $provider , '' => true,'placeholder' => 'Please Select','style'=>'width:400px']); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group">
                                    <?php echo $this->Form->text('reminder', ['label'=> '', 'class'=> 'form-control', 'id'=>'datepicker-autoclose', 'placeholder'=>'mm/dd/yyyy','value'=>$agreement->reminder->i18nFormat('MM/dd/yyyy')]);?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-daterange input-group" id="date-range" style="padding-bottom: 30px;" >
                                    <?php echo $this->Form->text('start_date', ['label'=> '', 'class'=> 'form-control',  'placeholder'=>'mm/dd/yyyy','value'=>$agreement->start_date->i18nFormat('MM/dd/yyyy')]);?>
                                    <span class="input-group-addon">to</span>
                                    <?php echo $this->Form->text('end_date', ['label'=> '', 'class'=> 'form-control', 'placeholder'=>'mm/dd/yyyy','value'=>$agreement->end_date->i18nFormat('MM/dd/yyyy')]);?>
