        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <?php  if ($this->request->getSession()->read('Auth')&&$this->request->getSession()->read('Auth')["User"]["role"]=="admin") { ?>
                    <li>
                        <?php echo $this->Html->link('<i class="fa fa-address-book-o"></i><span class="nav-text">User</span>', array('controller' => 'Users', 'action' => 'index'), ['escape' => false]); ?>
                    </li>
                        <?php } ?>
