                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <?php echo $this->Form->control('department_id', ['label'=>'','id'=>'department_id', 'class'=>'form-control', 'options' => $department , '' => true,'placeholder' => 'Please Select','style'=>'width:400px']); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <?php echo $this->Form->control('provider_id', ['label'=>'','id'=>'provider_id', 'class'=>'form-control', 'options' => $provider , '' => true,'placeholder' => 'Please Select','style'=>'width:400px']); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <?php echo $this->Form->control('member_id', ['label'=>'','id'=>'val-member','class' => 'form-control','options' => $placementMember, '' => true, 'placeholder' => 'Please select member', 'style'=>'width:400px']);?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-xs-3"><?= $this->Form->control('status', ['options' => $options, 'empty' => 'Please Select','class'=>'form-control', 'label' => '','style'=>'width:300px']) ?></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group">
                                    <?php echo $this->Form->text('reminder', ['label'=> '', 'class'=> 'form-control', 'id'=>'datepicker-autoclose', 'placeholder'=>'mm/dd/yyyy','value'=>$schedule->reminder->i18nFormat('MM/dd/yyyy')]);?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-daterange input-group" id="date-range" style="padding-bottom: 30px;" >
                                    <?php echo $this->Form->text('start_date', ['label'=> '', 'class'=> 'form-control',  'placeholder'=>'mm/dd/yyyy','value'=>$schedule->start_date->i18nFormat('MM/dd/yyyy')]);?>
                                    <span class="input-group-addon">to</span>
                                    <?php echo $this->Form->text('end_date', ['label'=> '', 'class'=> 'form-control', 'placeholder'=>'mm/dd/yyyy','value'=>$schedule->end_date->i18nFormat('MM/dd/yyyy')]);?>
                                </div>
                            </div>
